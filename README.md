# Ethiopian-telecom-customer-service-system
This project is design and implement a C++ program that simulates the Ethiopian Telecom Customer Service System using arrays, control statements, and input validation.
#include <iostream>
#include <string>
using namespace std;
...
// Region Data
string regionNames[MAX_REGIONS];
...
int regionCustomerCount[MAX_REGIONS] = {0};
int cityCustomerCount[MAX_CITIES] = {0};

// Tracking arrays for the reporting logic
int cityRegion[MAX_CITIES];          
...
int main()
{
    cout << "=============== Ethiopian Telecom Customer Service System =============" << endl;
